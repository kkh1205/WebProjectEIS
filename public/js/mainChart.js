...
window.onload = function () {
    sendAjax2021("https://eissistem.herokuapp.com/main.html");
};
...
function sendAjax2021(url) {
    ...
    console.log(quarterlySales); */
        ...
        document.getElementById("YPP").innerHTML =
            year + " 분기별 매출액 & 영업이익";
        document.getElementById("YE").innerHTML = year + "년도 수출 현황";
        document.getElementById("exampleModalLabelAmerica").innerHTML =
            year + " 미국";
        document.getElementById("exampleModalLabelSouthAmerica").innerHTML =
            year + " 남미";
        document.getElementById("exampleModalLabelEurope").innerHTML =
            year + " 유럽";
        document.getElementById("exampleModalLabelAfrica").innerHTML =
            year + " 아프리카";
        document.getElementById("exampleModalLabelAsia").innerHTML =
            year + " 아시아";
        document.getElementById("exampleModalLabelAust").innerHTML =
            year + " 호주";
    });
}
...
function Yselecter(year) {
    switch (year) {
        case "2021":
            ...
            break;
        case "2020":
            sendAjax2020("https://eissistem.herokuapp.com/main.html");
            console.log("2020");
            break;
        case "2019":
            sendAjax2019("https://eissistem.herokuapp.com/main.html");
            console.log("2019");
            break;
    }
}
