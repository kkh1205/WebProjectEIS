    ...
    options: {onClick: function clickHandler(evt) {
      ...
      if (points.length) {
          ...
          var value =
              ...
              document.querySelector('#kk1').innerHTML = listPer2021[seqcence+1]
              document.querySelector('#ss1').innerHTML = listPer2021[seqcence+2]
              document.querySelector('#yy1').innerHTML = listPer2021[seqcence+3]
              ...
              switch (valueyear) {
                  case "2021":
                      ...
                      document.querySelector('#ss4').innerHTML = listPer2021[seqcence+0] + "%";
                      document.querySelector('#yy4').innerHTML = "72.4%";
                      document.querySelector('#kk5').innerHTML = listPer2021[seqcence+0] + "%";
                      document.querySelector('#ss5').innerHTML = "30.2%";
                      document.querySelector('#yy5').innerHTML = listPer2021[seqcence+0] + "%";
                      document.querySelector('#kk6').innerHTML = "20.9%";
                      document.querySelector('#ss6').innerHTML = "41.6%";
                      document.querySelector('#yy6').innerHTML = listPer2021[seqcence+0] + "%";
                      break;
                  case "2020":
          ...
          document.querySelector("#ModalLabel2").innerHTML = label + " 평가 등급";
    ...
    options: {onClick: function clickHandler(evt) {
      ...
      if (points.length) {
          ...
          var value =
              ...
              switch (valueyear) {
                  case "2021":
                      document.querySelector('#kk1').innerHTML = listPer2021[seqcence+0] + "%";
                      document.querySelector('#ss1').innerHTML = listPer2021[seqcence+1] + "%";
                      document.querySelector('#yy1').innerHTML = listPer2021[seqcence+2] + "%";
                      document.querySelector('#kk2').innerHTML = listPer2021[seqcence+3] + "%";
                      document.querySelector('#ss2').innerHTML = listPer2021[seqcence+4] + "%";
                      document.querySelector('#yy2').innerHTML = listPer2021[seqcence+5] + "%";
                      document.querySelector('#kk3').innerHTML = listPer2021[seqcence+6] + "%";
                      document.querySelector('#ss3').innerHTML = listPer2021[seqcence+7] + "%";
                      document.querySelector('#yy3').innerHTML = listPer2021[seqcence+8] + "%";
                      break;
                  case "2020":
                      document.querySelector('#kk1').innerHTML = listPer2020[seqcence+0] + "%";
                      document.querySelector('#ss1').innerHTML = listPer2020[seqcence+1] + "%";
                      document.querySelector('#yy1').innerHTML = listPer2020[seqcence+2] + "%";
                      document.querySelector('#kk2').innerHTML = listPer2020[seqcence+3] + "%";
                      document.querySelector('#ss2').innerHTML = listPer2020[seqcence+4] + "%";
                      document.querySelector('#yy2').innerHTML = listPer2020[seqcence+5] + "%";
                      document.querySelector('#kk3').innerHTML = listPer2020[seqcence+6] + "%";
                      document.querySelector('#ss3').innerHTML = listPer2020[seqcence+7] + "%";
                      document.querySelector('#yy3').innerHTML = listPer2020[seqcence+8] + "%";
                      break;
                  case "2019":
                      document.querySelector('#kk1').innerHTML = listPer2019[seqcence+0] + "%";
                      document.querySelector('#ss1').innerHTML = listPer2019[seqcence+1] + "%";
                      document.querySelector('#yy1').innerHTML = listPer2019[seqcence+2] + "%";
                      document.querySelector('#kk2').innerHTML = listPer2019[seqcence+3] + "%";
                      document.querySelector('#ss2').innerHTML = listPer2019[seqcence+4] + "%";
                      document.querySelector('#yy2').innerHTML = listPer2019[seqcence+5] + "%";
                      document.querySelector('#kk3').innerHTML = listPer2019[seqcence+6] + "%";
                      document.querySelector('#ss3').innerHTML = listPer2019[seqcence+7] + "%";
                      document.querySelector('#yy3').innerHTML = listPer2019[seqcence+8] + "%";
                      break;
          ...
          document.querySelector("#ModalLabel1").innerHTML = label + " 가동률 지표";
...
window.onload = function () {
  sendAjax2021("http://localhost:3000/quality.html");
};
...
// 해당 창이 켜질 때, sandAjax를 호출.
  function sendAjax2021(url) {
    ...
    oReq.addEventListener('load', function() {
      ...
      for (var i = 12; i < 15; i++) {
        ...
        document.querySelector(`#k${i-11}`).innerHTML = val2021[i]+ "PPM";
      }
      for (var i = 12; i < 15; i++) {
          console.log(val2020[i]);
          document.querySelector(`#s${i-11}`).innerHTML = val2020[i] + "PPM";
      }
      for (var i = 12; i < 15; i++) {
        console.log(val2019[i]);
        document.querySelector(`#y${i-11}`).innerHTML = val2019[i] + "PPM";
      }


      for (var i = 12; i < 15; i++) {
        console.log(bill2021[i]);
        document.querySelector(`#k${i-8}`).innerHTML = bill2021[i]+ "만원";
      }
      for (var i = 12; i < 15; i++) {
          console.log(bill2020[i]);
          document.querySelector(`#s${i-8}`).innerHTML = bill2020[i] + "만원";
      }
      for (var i = 12; i < 15; i++) {
        console.log(bill2019[i]);
        document.querySelector(`#y${i-8}`).innerHTML = bill2019[i] + "만원";
      }
  ...
  function sendAjax2020(url) {
    ...
    oReq.addEventListener('load', function() {
      ...
      for (var i = 11; i < 14; i++) {
        console.log(val2021[i]);
        document.querySelector(`#k${i-10}`).innerHTML = val2021[i]+ "PPM";
      }
      for (var i = 11; i < 14; i++) {
          console.log(val2020[i]);
          document.querySelector(`#s${i-10}`).innerHTML = val2020[i] + "PPM";
      }
      for (var i = 11; i < 14; i++) {
        console.log(val2019[i]);
        document.querySelector(`#y${i-10}`).innerHTML = val2019[i] + "PPM";
      }


      for (var i = 11; i < 14; i++) {
        console.log(bill2021[i]);
        document.querySelector(`#k${i-7}`).innerHTML = bill2021[i]+ "만원";
      }
      for (var i = 11; i < 14; i++) {
          console.log(bill2020[i]);
          document.querySelector(`#s${i-7}`).innerHTML = bill2020[i] + "만원";
      }
      for (var i = 11; i < 14; i++) {
        console.log(bill2019[i]);
        document.querySelector(`#y${i-7}`).innerHTML = bill2019[i] + "만원";
      }
  ...
  function yearSelect(year) {
    switch (year) {
        ...
        case "2020":
            console.log("과거1년전");
            sendAjax2020("http://localhost:3000/quality.html");
            break;
        case "2019":
            console.log("과거2년전");
            sendAjax2019("http://localhost:3000/quality.html");
            break;
        default:
            console.log("놀고싶다");
    }
...
var data4 = {
  labels: ["2021-09-01","2021-09-02","2021-09-03","2021-09-04","2021-09-05","2021-09-06"],
  datasets: [
    {
      label: 'A-01',
      data:[getRandomInt(-50,20), getRandomInt(-10,30), getRandomInt(-10,80),getRandomInt(-10,50), getRandomInt(-10,70), getRandomInt(-10,90)],
    ...
    {
      label: 'A-02',
      data: [getRandomInt(-10,50), getRandomInt(-10,70), getRandomInt(-10,90),getRandomInt(-10,30), getRandomInt(-10,40), getRandomInt(-10,30)],
    ...
    {
      label: 'A-03',
      data: [getRandomInt(-10,30), getRandomInt(-10,40), getRandomInt(-10,30),getRandomInt(-10,50), getRandomInt(-10,70), getRandomInt(-10,90)],
